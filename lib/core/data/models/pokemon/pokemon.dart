...
Pokemon pokemonFromJson(String str) => Pokemon.fromJson(json.decode(str) as Map<String, dynamic>);
...
class AbilityResource with _$AbilityResource {
    ...
    factory AbilityResource.fromJson(Map<String, dynamic> json) => _$AbilityResourceFromJson(json);
}